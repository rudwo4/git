	...
	<div class="table-responsive">
		<table class="table table-hover">
		  ...
		  <c:forEach var = "list" items="${list}">
		    ...
		    <tr>
			  <th scope="row"><fmt:formatDate value="${list.c_date}" pattern="yy/MM/dd/"/></th>
			  <th>
			  ...
			  <th>
			  <fmt:formatNumber type="number" maxFractionDigits="3" value="${list.c_cnt}"></fmt:formatNumber>
			  <input type ="hidden" id="cnt" value="${list.c_cnt}">
			  </th>
