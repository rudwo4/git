										 ...
										 <!-- 게시글이 있으면 -->
											<c:if test="${cnt2>=0}">
												<c:forEach items="${list2}" var="list2">
													<tr>
														<td text-align="left" style="border-bottom:none;padding : 5px 5px 5px 50px;">
															<fmt:formatDate type="both" pattern="yyyy-MM-dd HH:mm" value="${list2.pay_date}"/>
														</td>
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list2.pay_price}원</td>
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list2.money}원</td>
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list2.transfermessage}</td>
													</tr>
													<tr>
														<td style="border-top : none;padding : 5px 5px 5px 50px;">${list2.you}</td>
											...
											<c:if test="${cnt3>0}">
												<c:forEach var="list3" items="${list3}">
													<tr>
														...
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list3.pay_price}원</td>
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list3.money}원</td>
														<td rowspan="2" style="text-align : center; padding-top : 20px; padding-bottom : 0px;">${list3.withdrawmessage}</td>
													</tr>
													<tr>
														<td style="border-top : none; padding : 5px 5px 5px 50px;">${list3.you}</td>
