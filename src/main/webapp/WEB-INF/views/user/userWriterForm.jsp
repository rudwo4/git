...
<head>
  <meta charset="utf-8">
	...
	<link rel="stylesheet" href="${project}assets/vendor_plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.css">
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form action="${path}/stock/writePro" method="post">
        ...
        <div class="col-12">
          <div class="box">
            ...
            <div class="box-header">
              ...
              <input type="text" class="form-control" placeholder="제목을 입력하세요" name="subject" required>
              <!-- tools box -->
            ...
            <div class="box-body">
              ...
              <div style='display:inline;'>
	              <div style='display:inline;float:right; margin-left:10px;margin-top:20px;'><input class="btn btn-block btn-default btn-lg" type="submit" style="width:150px;" value="작성"></div>
				  <div style='display:inline;float:right; margin-left:10px;margin-top:20px;'><input class="btn btn-block btn-default btn-lg" type="reset" style="width:150px;" value="취소"></div>
				  <div style='display:inline;float:right; margin-left:10px;margin-top:20px;'><input class="btn btn-block btn-default btn-lg" type="button" style="width:150px;" value="목록" onclick="window.history.go(-1);"></div>
			  </div>
            </div>
          </div>
          <!-- /.box -->
